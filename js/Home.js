...
function Existing1(data){
    ...
    column1 = Row1.insertCell(0).innerHTML = data.difficulty;
    ...
    `<input class="optionsTable_home edit_home" onClick="Edit1(this, ${data.id})" value="Editar">
    <input class="optionsTable_home delete_home" onClick="Delete1(this, ${data.id})" value="Eliminar">
    <a class="optionsTable_home delete_home" href="/EventPage.html?id=${data.id}&type=e">Veure més</a>`;
...
function Existing2(data){
    ...
    column2 = Row2.insertCell(0).innerHTML = data.difficulty;
    ...
    `<input class="optionsTable_home edit_home" onClick="Edit2(this, ${data.id})" value="Editar">
    <input class="optionsTable_home delete_home" onClick="Delete2(this, ${data.id})" value="Eliminar">
    <a class="optionsTable_home delete_home" href="/EventPage.html?id=${data.id}&type=p">Veure més</a>`;
...
function Existing3(data){
    ...
    column3 = Row3.insertCell(0).innerHTML = data.difficulty;
    ...
    `<input class="optionsTable_home edit_home" onClick="Edit3(this, ${data.id})" value="Editar">
    <input class="optionsTable_home delete_home" onClick="Delete3(this, ${data.id})" value="Eliminar">
    <a class="optionsTable_home delete_home" href="/EventPage.html?id=${data.id}&type=d">Veure més</a>`;
...
function InsertData1(data) {
    ...
    column3 = Row1.insertCell(3).innerHTML =
    `<input class="optionsTable_home edit_home" onClick="Edit1(this, ${arrayExamens.length + 1})" value="Editar">
    <input class="optionsTable_home delete_home" onClick="Delete1(this, ${arrayExamens.length + 1})" value="Eliminar">
    <a class="optionsTable_home delete_home" href="/EventPage.html?id=${arrayExamens.length + 1}&type=e">Veure més</a>`;
    document.getElementById('difficulty1').focus();
...
function InsertData2(data) {
    ...
    column2 = Row2.insertCell(0).innerHTML = data.difficulty2;
    column2 = Row2.insertCell(1).innerHTML = data.name2;
    column3 = Row2.insertCell(2).innerHTML = data.date2;
    column3 = Row2.insertCell(3).innerHTML = 
    `<input class="optionsTable_home edit_home" onClick="Edit2(this, ${arrayProjectes.length + 1})" value="Editar">
    <input class="optionsTable_home delete_home" onClick="Delete2(this, ${arrayProjectes.length + 1})" value="Eliminar">
    <a class="optionsTable_home delete_home" href="/EventPage.html?id=${arrayProjectes.length + 1}&type=p">Veure més</a>`;
    document.getElementById('difficulty2').focus();
...
function InsertData3(data) {
    ...
    column3 = Row3.insertCell(0).innerHTML = data.difficulty3;
    column2 = Row3.insertCell(1).innerHTML = data.name3;
    column3 = Row3.insertCell(2).innerHTML = data.date3;
    column3 = Row3.insertCell(3).innerHTML = 
    `<input class="optionsTable_home edit_home" onClick="Edit3(this, ${arrayDeures.length + 1})" value="Editar"></input>
    <input class="optionsTable_home delete_home" onClick="Delete3(this, ${arrayDeures.length + 1})" value="Eliminar">
    <a class="optionsTable_home delete_home" href="/EventPage.html?id=${arrayDeures.length + 1}&type=d">Veure més</a>`;
    document.getElementById('difficulty3').focus();
